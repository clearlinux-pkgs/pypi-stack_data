...
Version  : 0.6.1
Release  : 15
URL      : https://files.pythonhosted.org/packages/ac/64/2566177ef0a40ca565c230383b13673de6cffa71f75344cdadcff942cd6b/stack_data-0.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/ac/64/2566177ef0a40ca565c230383b13673de6cffa71f75344cdadcff942cd6b/stack_data-0.6.1.tar.gz
...
%prep
%setup -q -n stack_data-0.6.1
cd %{_builddir}/stack_data-0.6.1
pushd ..
cp -a stack_data-0.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668449577
...
cp %{_builddir}/stack_data-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-stack_data/44c582803d7005baacb1ad03bcc5ad393cbdd95f || :
