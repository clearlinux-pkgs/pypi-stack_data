...
Source0  : https://files.pythonhosted.org/packages/28/e3/55dcc2cfbc3ca9c29519eb6884dd1415ecb53b0e934862d3559ddcb7e20b/stack_data-0.6.3.tar.gz
...
%prep
%setup -q -n stack_data-0.6.3
cd %{_builddir}/stack_data-0.6.3
pushd ..
cp -a stack_data-0.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696263175
