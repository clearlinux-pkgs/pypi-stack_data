...
Source0  : https://files.pythonhosted.org/packages/ff/d0/9231ffa0d7b5a93ffaa45b35f06502812829c6429907384534ce1ff79ac4/stack_data-0.6.0.tar.gz
...
%prep
%setup -q -n stack_data-0.6.0
cd %{_builddir}/stack_data-0.6.0
pushd ..
cp -a stack_data-0.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667228209
