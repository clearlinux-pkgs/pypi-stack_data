...
Source0  : https://files.pythonhosted.org/packages/d6/3a/6baf4a5e7b48f00bc636bc878c6d93afd032dfeafc10b4a0a5a27232efb3/stack_data-0.5.0.tar.gz
...
%prep
%setup -q -n stack_data-0.5.0
cd %{_builddir}/stack_data-0.5.0
pushd ..
cp -a stack_data-0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661793044
